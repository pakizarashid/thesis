...
Generated from 43 files in results/. Values under 'this project' are measured; the two reference blocks below are literal transcriptions of published numbers, not measured here.
